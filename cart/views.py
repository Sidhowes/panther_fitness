...
def add_to_cart(request, item_id):
    """ Add a qauantity of the specified product to the shopping cart."""
    ...
    if size:
        ...
        if item_id in list(cart.keys()):
            ...
            messages.success(request, f'Updated {product.name} quantity {cart[item_id]}')
        else:
            cart[item_id] = quantity
...
def update_cart(request, item_id):
    """ update the quantity in the cart template."""
...
def remove_cart(request, item_id):
    """ remove item in the cart template."""
